...
const transactionRepositorie = {
    bilan: (trans) =>{
        ...
        if(trans){
            ...
            bilan.push({label:'Total Des Entréess', value:entrees, ref:undefined, type: 'input', order: 7})
            bilan.push({label:'Total Des Sorties:', value:sorties, ref:undefined, type: 'output', order: 8})
            bilan.push({label:'Différence', value:diff, ref:undefined, type: diff > 0? 'input':'output', order: 9})
        }
